...
with open(os.path.join(here, 'brainscalon/', '__init__.py'), 'r') as f:
    init_py = f.read()
...
packages = find_packages(
    exclude=[
        ...
        "dev*",
        "dist*",
        "brainscalon.egg-info*",
        "brainscalon/__pycache__*",
        "brainscalon/__init__.py",
    ]
)
...
setup(
    name='brainscalon',
    version=version,
    description='Scalable Online Learning in Biological Neural Networks.',
