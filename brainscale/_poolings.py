...
class Flatten(DnnLayer, ExplicitInOutSize):
  ...
  def __init__(self,
               start_dim: int = 0,
               end_dim: int = -1,
               in_size: Optional[Size] = None) -> None:
    super().__init__()
    ...
    if in_size is not None:
      ...
      y = jax.eval_shape(functools.partial(bc.math.flatten, start_dim=start_dim, end_dim=end_dim),
                         jax.ShapeDtypeStruct(self.in_size, bc.environ.dftype()))
  ...
  def update(self, x):
    ...
    return bc.math.flatten(x, start_dim, self.end_dim)
...
class Unflatten(DnnLayer, ExplicitInOutSize):
  ...
  * :attr:`unflattened_size` is the new shape of the unflattened dimension of the tensor and it can be
  ...
  def __init__(self,
    ...
    if in_size is not None:
      self.in_size = tuple(in_size)
      y = jax.eval_shape(functools.partial(bc.math.unflatten, dim=dim, sizes=sizes),
                         jax.ShapeDtypeStruct(self.in_size, bc.environ.dftype()))
      self.out_size = y.shape

  def update(self, x):
    dim = self.dim + 1 if self.mode.has(bc.mixin.Batching) else self.dim
    return bc.math.unflatten(x, dim, self.sizes)
...
class _MaxPool(DnnLayer, ExplicitInOutSize):
  def __init__(
    ...
    if in_size is not None:
      ...
      y = jax.eval_shape(self.update, jax.ShapeDtypeStruct((128,) + in_size, bc.environ.dftype()))
...
class MaxPool1d(_MaxPool):
  ...
  Examples::
      ...
      >>> input = bm.random.randn(20, 50, 16)
      >>> output = m(input)
      >>> output.shape
      (20, 24, 16)
...
class MaxPool2d(_MaxPool):
  ...
  Examples::
      ...
      >>> input = bm.random.randn(20, 50, 32, 16)
      >>> output = m(input)
      >>> output.shape
      (20, 24, 31, 16)
...
class MaxPool3d(_MaxPool):
  ...
  Examples::
      ...
      >>> input = bm.random.randn(20, 50, 44, 31, 16)
      >>> output = m(input)
      >>> output.shape
      (20, 24, 43, 15, 16)
...
class AdaptiveAvgPool2d(_AdaptivePool):
  ...
  Examples:
      ...
      >>> input = bm.random.randn(1, 8, 9, 64)
      >>> output = m(input)
      >>> output.shape
      (1, 5, 7, 64)
      >>> # target output size of 7x7 (square)
      >>> m = AdaptiveMaxPool2d(7)
      >>> input = bm.random.randn(1, 10, 9, 64)
      >>> output = m(input)
      >>> output.shape
      (1, 7, 7, 64)
...
class AdaptiveAvgPool3d(_AdaptivePool):
  ...
  Examples:
      ...
      >>> input = bm.random.randn(1, 8, 9, 10, 64)
      >>> output = m(input)
      >>> output.shape
      (1, 5, 7, 9, 64)
      >>> # target output size of 7x7x7 (cube)
      >>> m = AdaptiveMaxPool3d(7)
      >>> input = bm.random.randn(1, 10, 9, 8, 64)
      >>> output = m(input)
      >>> output.shape
      (1, 7, 7, 7, 64)
