...
def main():
    ...
    module_and_name = [
        ('_connections', 'Connection Operation'),
        ('_elementwise', 'Element-wise Operation'),
        ('_neurons', 'Neuronal Dynamics'),
        ('_synapses', 'Synaptic Dynamics'),
        ('_normalizations', 'Normalization Operation'),
        ('_poolings', 'Pooling Operation'),
