...
import brainscalon
from brainscalon import _etrace_model_with_group_state as group_etrace_model
from brainscalon._etrace_compiler_hidden_group import find_hidden_groups_from_module
from brainscalon._etrace_compiler_hidden_group import group_merging
...
class Test_module_with_group_state:
    ...
    def test_snn_single_layer_state_transition(
        ...
        with bst.environ.context(dt=0.1 * u.ms):
            ...
            graph_without_group = brainscalon.compile_etrace_graph(layer_without_group, input)
            graph_with_group = brainscalon.compile_etrace_graph(layer_with_group, input)
