    ...
    **Second**, the algorithm computes the spatial gradient $\partial L^t / \partial H^t$ using the standard
    ...
    def update(self, *args) -> Any:
        ...
        .. code-block:: python
            ...
            x = [brainscalon.SingleStepData(jnp.ones((10,))),
                 brainscalon.SingleStepData(jnp.zeros((10,)))]
        ...
        .. code-block:: python
            ...
            x = [brainscalon.MultiStepData(jnp.ones((5, 10)),
                 jnp.zeros((10,)))]
...
class IODimVjpAlgorithm(ETraceVjpAlgorithm):
    ...
    name: str, optional
        The name of the etrace algorithm.
    mode: Optional[brainscalon.mixin.Mode]
