...
class HiddenParamOpRelation(NamedTuple):
    ...
    Example::
        ...
        >>> import brainscalon
        >>> import brainstate
        >>> gru = brainscalon.nn.GRUCell(10, 20)
        >>> gru.init_state()
        >>> inputs = brainstate.random.randn(10)
        >>> hpo_relations = brainscalon.find_hidden_param_op_relations_from_module(gru, inputs)
...
HiddenParamOpRelation.__module__ = 'brainscalon'
