...
from brainscalon._etrace_concepts import ETraceParam
from brainscalon._etrace_operators import MatMulOp, LoraOp, SpMVOp
from brainscalon._typing import ArrayLike
...
class LoRA(brainstate.nn.Module):
    ...
    Example usage::
        ...
        >>> layer = brainscalon.nn.LoRA(3, 2, 4)
        ...
        >>> wrapper = brainscalon.nn.LoRA(3, 2, 4, base_module=linear)
