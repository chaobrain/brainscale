...
import brainscalon
from brainscalon._etrace_compiler_hidden_pertubation import add_hidden_perturbation_in_module
...
class TestFindHiddenGroupsFromModule:
    ...
    def test_rnn_one_layer(self, cls):
        ...
        states = bst.graph.states(gru, brainscalon.ETraceState)
    ...
    def test_snn_single_layer(self, cls):
        ...
        with bst.environ.context(dt=0.1 * u.ms):
            ...
            states = bst.graph.states(layer, brainscalon.ETraceState)
